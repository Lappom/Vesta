...
const LIST_HERO_MARKUP = `
  ...
  <path d="M155 30 C165 20 175 35 170 50 C180 55 175 70 160 65 C155 80 140 75 145 60 C130 55 135 35 155 30Z" fill="#ff4d8b" opacity="0.8"/>
`;
...
export function ListHero({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
      aria-hidden
      dangerouslySetInnerHTML={{ __html: LIST_HERO_MARKUP }}
    />
  );
}
